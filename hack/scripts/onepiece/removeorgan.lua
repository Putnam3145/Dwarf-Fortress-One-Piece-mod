--removes any arbitrary organ

--Made by warmist, originally removed heart (if you couldn't tell)

--Done Trafalgar Law-style, so no death here
...
local heart_id=findBodyPart(df.creature_raw.find(trg.race).caste[trg.caste],...)
--ripping part
-- [[
local body=trg.body
...
body.wounds:insert("#",{new=true,id=wid,flags={severed_part=true,mortal_wound=true},
    parts={
    {new=true,body_part_id=heart_id,bleeding=0,pain=0,surface_perc=100}
    }})
--]]
--placing heart part
